...
// IsNotFoundError returns true when the error is NotFoundError
func IsNotFoundError(err error) bool {
	return IsError(err, NotFoundCode)
}

// IsConflictError checks whether the err chain contains conflict error
func IsConflictError(err error) bool {
	return IsError(err, ConflictCode)
}

func IsChallengesUnsupportedError(err error) bool {
	return IsError(err, ChallengesUnsupportedCode)
}
